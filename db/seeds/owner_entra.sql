...
--
-- Creates the firm owner (deepak@hsdg.in) with the highest access: both the
...
-- user's Entra UPN (deepak@hsdg.in).
--
...
SELECT 'deepak@hsdg.in', 'Deepak Kumar', o.id, true
...
WHERE u.email = 'deepak@hsdg.in'::citext
...
LEFT JOIN hsdg.users u ON u.email = 'deepak@hsdg.in'::citext
