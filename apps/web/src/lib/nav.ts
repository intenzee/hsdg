...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Client Dependencies', href: '/my-work?tab=client-dependencies', icon: MessageSquareWarning, permission: PERMISSION.engagementRead, ready: true },
  { label: 'Tasks', href: '/my-work', icon: ListTodo, permission: PERMISSION.engagementRead, ready: true },
